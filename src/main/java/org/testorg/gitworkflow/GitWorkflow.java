...
public class GitWorkflow {
    public static void main(String[] args) {
        ...
        String step6 = "Review your changes and check your code before committing then";
        String step7 = "Execute git commit by using the IntelliJ Idea interface, where you can select what changes you want to commit";
        ...
        String step14 = "Do not forget that locally you are still on the new branch name, it's good to move back to master";
